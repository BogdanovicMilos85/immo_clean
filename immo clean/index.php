...
<html lang="sr">
    <head>
        ...
        <link href="css/codepan.css" rel="stylesheet">
    ...
    <body>
        ...
        <header class="main_menu_area ">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="#"><img src="img/immo_logo.jpg" alt=""></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a class="nav-link"  href="index-en.php"><img src="img/icon/en.png" alt="Engleski">EN</a></li>
                    </ul>
                </div>
            </nav>
        </header>
...
<div class="carousel-inner">
  ...
  <div class="carousel-item">
    <img class="d-block w-100" src="img/slider9.jpg" alt="Second slide">
  </div>
  <div class="carousel-item">
    <img class="d-block w-100" src="img/paralax3.jpg" alt="Third slide">
  </div>
</div>
<a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev">
  <span class="carousel-control-prev-icon strelica" style="background-color:black;" aria-hidden="true"></span>
  <span class="sr-only">Previous</span>
</a>
<a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
  <span class="carousel-control-next-icon strelica"  style="background-color:black;" aria-hidden="true"></span>
  <span class="sr-only">Next</span>
        ...
        <!--================Team People Area =================-->
        <section class="team_people_area u-margin-bottom-big">
                    ...
                    <div class="col-lg-6">
                        <div class="team_people_text">
                            <div class="l_title">
                                ...
                                <h6>O nama</h6>
                                <h2>Immo Clean, firma od poverenja</h2>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row feature_inner">
                    <div class="col-lg-4 col-sm-6">
                        <div class="feature_item m-t-100">
                            <div class="f_icon">
...
Ostvarujemo višegodišnju saradnju na obostrano zadovoljstvo.</p>
            ...
            <div class="right_text">
                <div class="right_text_inner">
                    <div class="text_3d">
                        <div class="l_title">
                            <img src="img/water4.png" alt="">
                            <!-- <h6>Discover the features</h6> -->
                            <h2>IMMO CLEAN</h2>
                        </div>
                        <p>Se od 2009. godine bavi profesionalnim čišćenjem i održavanjem higijene poslovnih i stambenih prostora. Mi smo austrijska firma koja Vam nudi evropski standard čišćenja i održavanja higijene po trenutno najpovoljnijim cenama na tržištu. Zapošljavamo više od sto visokoprofesionalnih radnika.
            ...
            <div class="container">
                <div class="world_map_inner">
                    ...
                    <div class="bd-callout">
                        <h3>Belgrade Office</h3>
                        <p>Arčibalda Rajsa 11v<br /> 11309 Čukarica </p>
                        <h4><a href="tel:+381117873111">Tel: +381 11 78 73 111</a> <a href="#">office@immoclean.org</a></h4>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="footer_copyright">
                <div class="container">
                    <div class="float-sm-left">
                        <h5>
Copyright Immo Clean &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
                          </h5>
                    </div>
        ...
        <script src="js/codepan.js"></script>
